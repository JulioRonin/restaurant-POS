...
import { LogIn, UserPlus, Building2, User, Mail, Lock, ArrowRight, ShieldCheck } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-solaris-black text-white overflow-hidden font-sans antialiased">
            ...
            >
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black tracking-tighter mb-2 uppercase italic text-white">Solaris OS</h1>
                            ...
                            {isSuccess ? (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400 font-medium leading-relaxed">Hemos enviado un enlace a <br/><span className="text-solaris-orange font-bold text-base">{email}</span></p>
                                    </div>
                                    <button 
                                        onClick={() => { setIsLogin(true); setIsSuccess(false); }}
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input 
                                                        ...
                                                        className="w-full bg-white/[0.02] border border-white/10 rounded-2xl pl-12 pr-4 py-4 text-sm focus:outline-none focus:border-solaris-orange/50 focus:bg-white/[0.05] transition-all placeholder:text-gray-700 font-medium text-white"
                                                    />
                                                </div>
                                            </div>
                                            <div className="space-y-2">
            ...
            <div className="absolute bottom-12 text-center w-full">
                <p className="text-[10px] font-black text-gray-700 uppercase tracking-[0.6em]">Powered by Ronin Solaris System</p>
            </div>
        </div>
    );
};
